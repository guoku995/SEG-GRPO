...
class VALDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #     "Output 1 to 4 positive_points inside the referred object; use more positive_points only when separate target regions may be missed. " \
        #     "Output 0 to 4 negative_points on wrong non-target regions only when the bbox may include them; use an empty list when no negative point is needed. " \
        #     "Both positive_points and negative_points fields are required. " \
                ...
                "content": [
                    ...
                    },
                    {
                        ...
                        "text": QUESTION_TEMPLATE.format(Question=sampled_sents[i].lower().strip("."),
                                                         ...
                                                         # Answer='{"bbox": [30,300,650,760], "positive_points": [[160,360],[220,600]], "negative_points": [[600,720]]}')
