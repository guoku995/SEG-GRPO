...
class TrainDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        QUESTION_TEMPLATE = \
            ...
            "Output 1 to 3 positive_points inside the referred object; use more positive_points only when separate target regions may be missed. " \
            "Output 0 to 3 negative_points on wrong non-target regions only when the bbox may include them; use an empty list when no negative point is needed. " \
                ...
                "content": [
                    {
                        ...
                        "text": QUESTION_TEMPLATE.format(Question=sampled_sents[i].lower().strip("."),
                                                         Answer='{"bbox": [10,100,200,210], "positive_points": [[30,110],[35,180]], "negative_points": [[180,190]]}')
                    }
                ],
            },
            ]
