...
class VALDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # QUESTION_TEMPLATE = \
        #     "Find '{Question}'." \
        #     "The image size is 840*840. Find the target's position in the image through reasoning." \
        ...
        #首次正负点 + 二次extra
        QUESTION_TEMPLATE = \
            "Find '{Question}' in the 840x840 image. " \
            "Return one bbox, one positive point on the target, and one negative point on nearby non-target background. " \
            "Output only: <answer>{Answer}</answer>." \
                ...
                "content": [
                    ...
                    },
                    {
                        ...
                        "text": QUESTION_TEMPLATE.format(Question=sampled_sents[i].lower().strip("."),
                                                         ...
                                                         Answer='{"bbox":[10,100,200,210],"positive_points":[[30,110]],"negative_points":[[180,190]]}')
